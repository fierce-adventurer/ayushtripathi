...
import { Mail, Phone, Linkedin, Send, Terminal } from 'lucide-react';
    ...
    <div id="contact" className="w-full pt-24 min-h-[70vh] mb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-8 shadow-xl relative overflow-hidden">
          {submitted ? (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-zinc-950/90 backdrop-blur-sm z-10 animate-in fade-in">
